...
unsigned char m37710_internal_r(int offset);
void m37710_internal_w(int offset, unsigned char data);
unsigned m37710_get_reg(int regnum);

void m37710_get_info(unsigned int state, union cpuinfo *info);
