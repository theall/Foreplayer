...
'DOMAIN_NAME':        '"Theall"',
'INTERNAL_NAME':      '"Foreplayer.exe"',
'FILE_DESCRIPTION':   '"Foreplayer Preview Edition."',
'LEGAL_COPYRIGHT':    '"Copyright (C) 2016-2017 Bilge Theall, All rights reserved."',
'ORIGINAL_FILE_NAME': '"Foreplayer.exe"',
'PRODUCT_NAME':       '"Foreplayer"',
'ORGANIZATION_DOMAIN':'"https://www.foreplayer.cn/"',
