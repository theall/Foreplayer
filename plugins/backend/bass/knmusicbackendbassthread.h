...
public:
    ...
    /*!
     * \brief Reimplemented from KNMusicStandardBackendThread::loadTrack().
     */
    bool loadTrack(const KNMusicTrackDetailInfo &trackInfo) Q_DECL_OVERRIDE;
    ...
    /*!
     * \brief Reimplemented from KNMusicStandardBackendThread::musicTypes().
     */
    QList<MusicType> musicTypes() const Q_DECL_OVERRIDE;
