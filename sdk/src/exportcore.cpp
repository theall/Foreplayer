...
bool TExportCore::loadTrack(TTrackItem *trackItem)
{
...
int TExportCore::samplesPerFrame(int sampleRate, int fps)
{
    int ret = 0;
    if(mCurrentPlugin)
...
void TExportCore::nextSamples(byte *buffer, int bufSize)
{
    if(mCurrentPlugin)
    {
