...
#define BASS_TAG_META		5	// ICY metadata : ANSI wstring
...
#define BASS_TAG_VENDOR		9	// OGG encoder : UTF-8 wstring
#define BASS_TAG_LYRICS3	10	// Lyric3v2 tag : ASCII wstring
...
#define BASS_TAG_RIFF_DISP	0x103 // RIFF "DISP" text tag : ANSI wstring
#define BASS_TAG_APE_BINARY	0x1000	// + index #, binary APE tag : TAG_APE_BINARY structure
#define BASS_TAG_MUSIC_NAME		0x10000	// MOD music name : ANSI wstring
#define BASS_TAG_MUSIC_MESSAGE	0x10001	// MOD message : ANSI wstring
#define BASS_TAG_MUSIC_ORDERS	0x10002	// MOD order list : BYTE array of pattern numbers
#define BASS_TAG_MUSIC_INST		0x10100	// + instrument #, MOD instrument name : ANSI wstring
#define BASS_TAG_MUSIC_SAMPLE	0x10300	// + sample #, MOD sample name : ANSI wstring
