...
extern "C" __declspec(dllexport) HANDLE __stdcall RAROpenArchive(struct RAROpenArchiveData *r)
{
...
extern "C" __declspec(dllexport) HANDLE PASCAL RAROpenArchiveEx(struct RAROpenArchiveDataEx *r)
{
  DataSet *Data=NULL;
  try
  {
...
extern "C" __declspec(dllexport) int PASCAL RARCloseArchive(HANDLE hArcData)
{
...
extern "C" __declspec(dllexport) int PASCAL RARReadHeader(HANDLE hArcData,struct RARHeaderData *D)
{
...
extern "C" __declspec(dllexport) int PASCAL RARReadHeaderEx(HANDLE hArcData,struct RARHeaderDataEx *D)
{
  DataSet *Data=(DataSet *)hArcData;
  try
  {
...
extern "C" __declspec(dllexport) int PASCAL ProcessFile(HANDLE hArcData,int Operation,char *DestPath,char *DestName,wchar *DestPathW,wchar *DestNameW)
{
  DataSet *Data=(DataSet *)hArcData;
  try
  {
...
extern "C" __declspec(dllexport) int PASCAL RARProcessFile(HANDLE hArcData,int Operation,char *DestPath,char *DestName)
{
...
extern "C" __declspec(dllexport) void PASCAL RARSetChangeVolProc(HANDLE hArcData,CHANGEVOLPROC ChangeVolProc)
{
  DataSet *Data=(DataSet *)hArcData;
...
extern "C" __declspec(dllexport) void PASCAL RARSetCallback(HANDLE hArcData,UNRARCALLBACK Callback,LPARAM UserData)
{
  DataSet *Data=(DataSet *)hArcData;
...
extern "C" __declspec(dllexport) void PASCAL RARSetProcessDataProc(HANDLE hArcData,PROCESSDATAPROC ProcessDataProc)
{
  DataSet *Data=(DataSet *)hArcData;
...
extern "C" __declspec(dllexport) int PASCAL RARGetDllVersion()
{
